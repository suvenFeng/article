...
<form action="${pageContext.request.contextPath}/blogger/register.do" method="post" onsubmit="return checkForm()">
    <DIV class="login-border">
        <DIV style="width: 165px; height: 240px; position: absolute;">
            <DIV class="tou"></DIV>
            <DIV class="initial_left_hand" id="left_hand"></DIV>
            <DIV class="initial_right_hand" id="right_hand"></DIV>
        </DIV>
        <P style="margin: 20px 10px; padding: 0 10px; position: relative;">
            用户名<INPUT id="username" name="username" class="ipt" type="text"
                   placeholder="请输入用户名">
        </P>
        <P style="margin: 20px 10px; padding: 0 10px; position: relative;">
            昵&nbsp;&nbsp;&nbsp;称<INPUT id="nickname" name="nickname" class="ipt" type="text"
                   placeholder="请输入昵称">
        </P>
        <P style="margin: 20px 10px; padding: 0 10px; position: relative;">
            密&nbsp;&nbsp;&nbsp;码<INPUT id="password" name="password" class="ipt" type="password"
                   placeholder="请输入密码">
        </P>
        <DIV style="height: 40px; line-height: 40px; margin-top: 20px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
            <P style="margin: 0px 35px 20px 45px;">
                <SPAN style="float: left;">我有账号,<a style="color:#3499da" href="${pageContext.request.contextPath}/register.jsp"> 登录</a></SPAN>
                <span>
